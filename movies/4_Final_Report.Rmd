...
From the graph, we can derive that there aren’t many records of movies released before 1980. It’s better to remove those records because they might not be representative.
...
As you can see, movies have multiple genres that they are associated with. For analysis purposes, we choose to use the first word in the genre column, as this is likely to be the most accurate description.
...
It is evident that the genres `Drama` and `Comdey` are the most frequently produced. However, this does not mean that they are the most profitable, returning successful ROI’s. This will further be explored.
...
The heat map above, depicts the most desired genres that a represented with higher frequencies. It is evident by the darker shades of blue becoming more prominent in the latter years. 
...
It is evident from the histogram that the majority of movies are rated between 6-8 out of 10. If a movie has a lower rating, it could either be the fact that it was unpopular or very bad. If a movie has a higher rating, it is evidently fantastic.
...
A spike in popularity in 2004 is obvious owing to the fact that there is a clear rise in popularity score. The spike is attributed to the development of facebook and the effect social media has influenced this. 
...
```
It is evident that as movie with a higher rating score, the more number of facebook likes increases. This is probably due to the fact that a critic giving a movie a good rating, will increase the want of people to see and find more out about the move. 

#### Top 20 directors with highest average IMDB score

When examining the directors with the highest IMDB scores we can establish the highest 	average rating is 8.6. Hence, movies with higher ratings are either excellent and/or fluke occurences. 
...
As we can see from the above heat map, movies became far less descriptive with one keyword per movie as time progressed. This could be due to creating stories with various situations and genres to make stories more meaningful.

Here we filter for after the year 2000 to ensure meaninful inferences. 
...
The level of anger in movies has remained fairly constant in recent years (2000-2016)
...
The level of anticipation in movies has remained fairly constant in recent years (2000-2016)
...
The level of disgust in movies has remained fairly constant in recent years (2000-2016)
...
The level of fear has remained fairly constant with a slight rise.
...
The level of joy in movies has remained fairly constant in recent years (2000-2016)
...
The level of sadness has remained fairly constant with a slight rise followed by a shallow dip.
...
Surprise is fairly constant with a very slight rise. 
...
Trust has decreased overall from the beginning however has steadied out toward the end. 
...
Negativity has remained fairly constant
...
Positivity has remained fairly constant and is rising in 2015. 



To conclude on the preliminary analysis: The data has been arranged, cleaned and improved on to make relevant inferences and observations. It is evident from the analysis which films gross well, have good ratings and feature succesful actors and directors. It is also evident that details such as the content rating and aspect ratio effect popularity. From here we can start the network analysis and further assessment of the data. 
