...
Let's have a look at the IMDB rating distribution on the number of movies that are produced. Below we can see that the data is slightly skewed to the left around the average IMDB score, meaning that major
...
Below is where the sentiment of keywords is calculated.
```{r}
